...
public class ArrayListDemo {
	public static void main(String[] args) {
		List<Employee> mylist1=new ArrayList<>(10);
		mylist1.add(new Employee("hello"));
		mylist1.add(new Employee("world"));
		mylist1.add(new Employee("moon"));
		mylist1.add(new Employee("mercury"));
